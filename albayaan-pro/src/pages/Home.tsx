        ...
        */}
        ...
        <div className="relative z-10 max-w-4xl mx-auto w-full space-y-6">
          ...
          >
            <Link
              href="/courses"
              className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-lg flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
            >
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-blue-600/15 to-purple-600/15 border border-border">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/courses" className="px-8 py-4 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-lg flex items-center justify-center gap-2 hover:opacity-90 transition-opacity">
                {t("Browse Courses", "تصفح الدورات", "Baadh Koorsooyinka")}
                <ArrowRight className="w-5 h-5" />
              </Link>
              <Link href="/pricing" className="px-8 py-4 rounded-full border border-border text-foreground font-bold text-lg flex items-center justify-center gap-2 hover:bg-white/5 transition-colors">
