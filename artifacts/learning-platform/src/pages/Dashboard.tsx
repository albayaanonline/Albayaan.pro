    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <h2 className="text-xl font-bold text-foreground mb-5">{t("Your Courses", "دوراتك", "Koorsooyinkaaga")}</h2>
              ...
              {enrolledCourses.map((course: any, i: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* CSS transition on progress bar instead of framer-motion animate to avoid reflow */}
                    <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                      <div
                        className="h-full rounded-full bg-gradient-to-r from-blue-500 to-purple-500 progress-bar-fill"
                        style={{ width: `${pct}%` }}
                      />
                    </div>
        ...
        <div>
          <h2 className="text-xl font-bold text-foreground mb-5">{t("Quick Actions", "إجراءات سريعة", "Tallaabooyin Degdeg ah")}</h2>
          <div className="space-y-3">
            {[
              ...
              <Link key={i} href={action.href} className="flex items-center gap-4 p-4 rounded-xl bg-card border border-border hover:border-primary/30 hover:bg-white/5 transition-all">
